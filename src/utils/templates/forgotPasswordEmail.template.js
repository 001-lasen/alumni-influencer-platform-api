module.exports = function forgotPasswordEmailTemplate(otp) {
    return `
    <!DOCTYPE html>
    <html>
    <head>
                            ...
                            <td style="padding:32px;">
                                ...
                                ">
                                    <p style="margin:0; color:#c62828; font-size:14px; line-height:1.6;">
                                        <strong>Didn't request this?</strong> If you believe someone is trying 
                                        to access your account, please contact our support team immediately at
                                        <a href="mailto:support@eastminster.ac.uk" style="color:#c62828;">
                                            support@eastminster.ac.uk
                                        </a>
                                    </p>
                                </div>
                            </td>
