...
db.userDetails.hasMany(db.profileImages, { foreignKey: 'userId', as: 'profileImages' });
db.profileImages.belongsTo(db.userDetails, { foreignKey: 'userId' });

db.userDetails.hasMany(db.degrees, { foreignKey: 'userId', as: 'degrees' });
db.degrees.belongsTo(db.userDetails, { foreignKey: 'userId' });

db.userDetails.hasMany(db.certifications, { foreignKey: 'userId', as: 'certifications' });
db.certifications.belongsTo(db.userDetails, { foreignKey: 'userId' });

db.userDetails.hasMany(db.licences, { foreignKey: 'userId', as: 'licences' });
db.licences.belongsTo(db.userDetails, { foreignKey: 'userId' });

db.userDetails.hasMany(db.professionalCourses, { foreignKey: 'userId', as: 'professionalCourses' });
db.professionalCourses.belongsTo(db.userDetails, { foreignKey: 'userId' });
